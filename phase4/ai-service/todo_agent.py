...
logger.info(f"TodoAgent initializing with BUSINESS_SERVICE_URL: {settings.BUSINESS_SERVICE_URL}")
 
class TodoAgent:
    def __init__(self):
        mcp_session.DEFAULT_TIMEOUT = 30.0
        ...
        logger.info(f"MCP Server will use BUSINESS_SERVICE_URL: {settings.BUSINESS_SERVICE_URL}")
